  ...
  (try
    (let [c (-> (conf/spark-conf)
          ...
          tf-by-doc (-> doc-term-seq
                        (f/map-to-pair (fd/tuple-fn (fn [doc-id [term term-freq doc-terms-count]]
          ...
          idf-by-term (-> doc-term-seq
                          (f/group-by (fd/tuple-fn (fn [_ [term _ _]] term)))
          ...
          tfidf-by-term (-> (f/join tf-by-doc idf-by-term)
                            ...
                            (f/map (fd/tuple-value-fn (fn [term [doc-id tf] idf]
                                         [doc-id term (* tf idf)])))
