(defproject gorillalabs/sparkling "1.2.4-SNAPSHOT"
            ...
            :aliases {"all" ["with-profile" "dev,spark-1.1.0,hadoop-2.6.0:dev,spark-1.2.1,hadoop-2.6.0:dev,spark-1.3.1,hadoop-2.6.0:dev,spark-1.4.0,hadoop-2.6.0:dev,spark-1.5.0,hadoop-2.6.0:dev,spark-1.6.0,hadoop-2.6.0"]
                      }
